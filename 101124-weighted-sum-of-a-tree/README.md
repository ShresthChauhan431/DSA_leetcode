# 101124. Minimum Total Price After Applying Discounts
...
Node`nums[i]`Depth (`d`)Weight051`5 * (3 - 1 + 1) = 15`122`2 * (3 - 2 + 1) = 4`232`3 * (3 - 2 + 1) = 6`312`1 * (3 - 2 + 1) = 2`443`4 * (3 - 3 + 1) = 4`563`6 * (3 - 3 + 1) = 6`
...
Node`nums[i]`Depth (`d`)Weight011`1 * (4 - 1 + 1) = 4`122`2 * (4 - 2 + 1) = 6`233`3 * (4 - 3 + 1) = 6`344`4 * (4 - 4 + 1) = 4`
